...
def signup():
    ...
    if request.method == "POST":
        ...
        code_formulaire = request.form.get("code")
        code_clinique = 000000
        print(f"{nom},{email}")
        ...
        if user:
            ...
            if password == password2 and code_formulaire == code_clinique:
                new_user = User( account_type = account_type, nom=nom, email=email,
